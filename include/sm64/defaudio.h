...
#define NA_SEQ_COSMIC           4
#define NA_SEQ_PUYOSUNSET       5
...
#define NA_BGM_COSMIC           NA_SEQ_COSMIC
#define NA_BGM_PUYOSUNSET       NA_SEQ_PUYOSUNSET
