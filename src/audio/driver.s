...
Na_driver_80314A30:
	la.u    $t0, _Na_work_bss_10-0x10+0x102
	la.l    $t0, _Na_work_bss_10-0x10+0x102
	lb      $t6, 0x0000($t0)
	addiu   $sp, $sp, -0x0020
	li      $at, 0x0001
	sw      $ra, 0x0014($sp)
	...
	beq     $t6, $at, 108$
	sw      $a1, 0x0024($sp)
	la.u    $a3, _Na_work_bss_10-0x10+0x10
	la.l    $a3, _Na_work_bss_10-0x10+0x10
	lbu     $t7, 0x0002($a3)
	sll     $t3, $a1, 2
	addu    $t3, $t3, $a1
	bnezl   $t7, 109$
...
Na_driver_80314DE4:
	...
	sw      $a0, 0x0040($sp)
	sw      $a1, 0x0044($sp)
	la.u    $s5, _Na_work_bss_10-0x10+0x5DDE
	li      $t7, 0x07000000
	la.l    $s5, _Na_work_bss_10-0x10+0x5DDE
	sw      $t7, 0x0000($a0)
	sw      $0, 0x0004($a0)
	lb      $s1, 0x0000($s5)
	move    $s2, $a3
	...
	blez    $s1, 69$
	move    $t6, $a0
	la.u    $s7, _Na_work_bss_10-0x10+0x10
	la.l    $s7, _Na_work_bss_10-0x10+0x10
	li      $s8, 0x0001
27$:
	bne     $s1, $s8, 31$
	addiu   $s3, $s1, -0x0001
...
Na_driver_80314F64:
	la.u    $t0, _Na_work_bss_10-0x10+0x10
	la.l    $t0, _Na_work_bss_10-0x10+0x10
	lbu     $t7, 0x0003($t0)
	sll     $t6, $a3, 2
	addiu   $sp, $sp, -0x00D0
	sll     $t8, $t7, 2
	...
	move    $a2, $v0
31$:
	lui     $t6, %hi(_Na_work_bss_10-0x10+0x102)
	lb      $t6, %lo(_Na_work_bss_10-0x10+0x102)($t6)
	li      $at, 0x0001
	li      $t2, 0x04000000
	bne     $t6, $at, 136$
	li      $t3, 0x80000000
...
288$:
	...
	jal     Na_driver_80315590
	sw      $v1, 0x00BC($sp)
	lui     $t9, %hi(_Na_work_bss_10-0x10+0x102)
	lb      $t9, %lo(_Na_work_bss_10-0x10+0x102)($t9)
	la.u    $t0, _Na_work_bss_10-0x10+0x10
	li      $at, 0x0001
	la.l    $t0, _Na_work_bss_10-0x10+0x10
	lw      $v1, 0x00BC($sp)
...
Na_driver_80315590:
	addiu   $sp, $sp, -0x0170
	lui     $t6, %hi(_Na_work_bss_10-0x10+0x5DD0)
	lw      $t6, %lo(_Na_work_bss_10-0x10+0x5DD0)($t6)
	sw      $s4, 0x0030($sp)
	move    $s4, $a2
	sw      $ra, 0x0044($sp)
	sw      $s8, 0x0040($sp)
	...
	sw      $0, 0x0064($sp)
20$:
	lui     $t8, %hi(_Na_work_bss_10-0x10+0x1870)
	lw      $t8, %lo(_Na_work_bss_10-0x10+0x1870)($t8)
	lw      $t7, 0x0064($sp)
	addu    $s7, $t7, $t8
	lw      $t9, 0x0000($s7)
	srl     $t6, $t9, 31
	...
	lw      $t9, 0x0000($s7)
	lbu     $v0, 0x0007($s7)
	lui     $t7, %hi(_Na_work_bss_10-0x10+0x730)
	lw      $t6, 0x016C($sp)
	addu    $t7, $t7, $v0
	lbu     $t7, %lo(_Na_work_bss_10-0x10+0x730)($t7)
	li      $at, 0x01000000
	slti    $t8, $t7, 0x0002
	beqz    $t8, 42$
	sll     $t9, $v0, 8
...
622$:
	lw      $t8, 0x0064($sp)
	addiu   $t6, $t9, 0x0001
	lui     $t9, %hi(_Na_work_bss_10-0x10+0x5DD0)
	lw      $t9, %lo(_Na_work_bss_10-0x10+0x5DD0)($t9)
	addiu   $t7, $t8, 0x00C0
	sw      $t7, 0x0064($sp)
	slt     $at, $t6, $t9
	bnez    $at, 20$
...
181$:
	...
	or      $t6, $t5, $at
	sw      $t6, 0x0000($t0)
	lui     $t7, %hi(_Na_work_bss_10-0x10+0x100)
	lh      $t7, %lo(_Na_work_bss_10-0x10+0x100)($t7)
	addiu   $s0, $s0, 0x0008
	li      $at, 0x09080000
	andi    $t8, $t7, 0xFFFF
	or      $t9, $t8, $at
	...
	sw      $t4, 0x0004($v1)
234$:
	lui     $t5, %hi(_Na_work_bss_10-0x10+0x11)
	lbu     $t5, %lo(_Na_work_bss_10-0x10+0x11)($t5)
	andi    $t7, $t1, 0x00FF
	sll     $t8, $t7, 16
	beqz    $t5, 299$
	move    $v1, $s0
...
Na_driver_80316AF4:
	...
	beqz    $v1, 59$
	move    $a3, $t6
	lui     $t7, %hi(_Na_work_bss_10-0x10+0x5DDF)
	lb      $t7, %lo(_Na_work_bss_10-0x10+0x5DDF)($t7)
	li      $at, 0x0001
...
59$:
	lui     $v0, %hi(_Na_work_bss_10-0x10+0x5DDF)
	beqz    $v1, 104$
	lb      $v0, %lo(_Na_work_bss_10-0x10+0x5DDF)($v0)
	bnez    $v0, 104$
	li      $at, 0x42FF0000
	mtc1    $at, $f4
