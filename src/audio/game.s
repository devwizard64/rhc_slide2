...
Na_game_8031E4F0:
	lui     $v1, %hi(_Na_work_bss_10-0x10+0x188)
	lw      $v1, %lo(_Na_work_bss_10-0x10+0x188)($v1)
	move    $v0, $0
	beqz    $v1, 10$
	nop
	addiu   $v0, $v0, 0x0001
6$:
	...
	move    $v0, $0
10$:
	lui     $v1, %hi(_Na_work_bss_10-0x10+0x358)
	lw      $v1, %lo(_Na_work_bss_10-0x10+0x358)($v1)
	beqzl   $v1, 20$
	addiu   $v0, $v0, 0x0001
	addiu   $v0, $v0, 0x0001
15$:
...
3$:
	mtc1    $a1, $f6
	addu    $t6, $t6, $a0
	la.u    $t7, _Na_work_bss_10-0x10+0x1878
	cvt.s.w $f8, $f6
	la.l    $t7, _Na_work_bss_10-0x10+0x1878
	sll     $t6, $t6, 6
	addu    $v0, $t6, $t7
	lwc1    $f4, 0x0018($v0)
	li      $t8, 0x0001
...
Na_game_8031E60C:
	sll     $t7, $a0, 2
	addu    $t7, $t7, $a0
	la.u    $t8, _Na_work_bss_10-0x10+0x1878
	la.l    $t8, _Na_work_bss_10-0x10+0x1878
	sll     $t7, $t7, 6
	addu    $v0, $t7, $t8
	lbu     $t9, 0x0002($v0)
	sw      $a2, 0x0008($sp)
...
.globl Na_Main
Na_Main:
	la.u    $a0, _Na_work_bss_10-0x10+0x5DE0
	la.l    $a0, _Na_work_bss_10-0x10+0x5DE0
	lw      $v0, 0x0000($a0)
	addiu   $sp, $sp, -0x0048
	...
	move    $v0, $0
16$:
	la.u    $a3, _Na_work_bss_10-0x10+0x5DEC
	la.l    $a3, _Na_work_bss_10-0x10+0x5DEC
	lw      $t5, 0x0000($a3)
	la.u    $v1, _Na_work_bss_10-0x10+0x5DE8
	la.l    $v1, _Na_work_bss_10-0x10+0x5DE8
	addiu   $t6, $t5, 0x0001
	div     $0, $t6, $v0
	lw      $t9, 0x0000($v1)
	mfhi    $t8
...
52$:
	...
	nop
	lw      $a2, 0x003C($sp)
	lui     $v1, %hi(_Na_work_bss_10-0x10+0x5EAC)
	la.u    $a3, _Na_work_bss_10-0x10+0x5DEC
	sll     $t5, $a2, 1
	addu    $v1, $v1, $t5
	lh      $v1, %lo(_Na_work_bss_10-0x10+0x5EAC)($v1)
	la.l    $a3, _Na_work_bss_10-0x10+0x5DEC
	srl     $t2, $v0, 2
	beqz    $v1, 74$
	sll     $t6, $a2, 2
	lui     $a0, %hi(_Na_work_bss_10-0x10+0x5EA0)
	addu    $a0, $a0, $t6
	lw      $a0, %lo(_Na_work_bss_10-0x10+0x5EA0)($a0)
	sll     $a1, $v1, 2
	...
	lw      $t2, 0x0044($sp)
74$:
	la.u    $t3, _Na_work_bss_10-0x10+0x5DE4
	la.l    $t3, _Na_work_bss_10-0x10+0x5DE4
	lw      $v0, 0x0000($t3)
	sw      $0, 0x0000($t3)
	lui     $v0, %hi(_Na_work_bss_10-0x10+0x5DE8)
	lw      $v0, %lo(_Na_work_bss_10-0x10+0x5DE8)($v0)
	la.u    $t8, _Na_work_bss_10-0x10+0x5E00
	la.u    $t1, _Na_work_bss_10-0x10+0x5DFC
	sll     $t7, $v0, 2
	addu    $t7, $t7, $v0
	sll     $t7, $t7, 4
	la.l    $t8, _Na_work_bss_10-0x10+0x5E00
	la.l    $t1, _Na_work_bss_10-0x10+0x5DFC
	addu    $t9, $t7, $t8
	lui     $t5, %hi(_Na_work_bss_10-0x10+0x5DF0)
	sll     $t4, $v0, 2
	sw      $t9, 0x0000($t1)
	addu    $t5, $t5, $t4
	lw      $t5, %lo(_Na_work_bss_10-0x10+0x5DF0)($t5)
	lui     $at, %hi(_Na_work_bss_10-0x10+0x5DF8)
	lui     $a0, %hi(_Na_work_bss_10-0x10+0x5DD4)
	sw      $t5, %lo(_Na_work_bss_10-0x10+0x5DF8)($at)
	lw      $a2, 0x0000($a3)
	lw      $a0, %lo(_Na_work_bss_10-0x10+0x5DD4)($a0)
	lui     $t7, %hi(_Na_work_bss_10-0x10+0x5EA0)
	sll     $t6, $a2, 2
	addu    $t7, $t7, $t6
	lw      $t7, %lo(_Na_work_bss_10-0x10+0x5EA0)($t7)
	subu    $t4, $a0, $t2
	lui     $at, %hi(_Na_game_bss+0x00)
	addiu   $t5, $t4, 0x0040
	la.u    $t9, _Na_work_bss_10-0x10+0x5EAC
	la.l    $t9, _Na_work_bss_10-0x10+0x5EAC
	andi    $t6, $t5, 0xFFF0
	sll     $t8, $a2, 1
	...
	addu    $t0, $t8, $t9
	sh      $t7, 0x0000($t0)
	lui     $a1, %hi(_Na_work_bss_10-0x10+0x5DD8)
	lw      $a1, %lo(_Na_work_bss_10-0x10+0x5DD8)($a1)
	lh      $v1, 0x0000($t0)
...
135$:
	lui     $a0, %hi(_Na_work_bss_10-0x10+0x5DF8)
	lui     $a2, %hi(_Na_game_bss+0x00)
	lw      $a2, %lo(_Na_game_bss+0x00)($a2)
	lw      $a0, %lo(_Na_work_bss_10-0x10+0x5DF8)($a0)
	addiu   $a1, $sp, 0x0040
	jal     Na_driver_80314DE4
	lh      $a3, 0x0000($t0)
	la.u    $t0, _Na_work_bss_10-0x10+0x5DE0
	lui     $at, %hi(_Na_work_bss_10-0x10+0x5DF8)
	sw      $v0, %lo(_Na_work_bss_10-0x10+0x5DF8)($at)
	la.l    $t0, _Na_work_bss_10-0x10+0x5DE0
	la.u    $a0, Na_Random
	lw      $t9, 0x0000($t0)
	la.l    $a0, Na_Random
	lw      $t4, 0x0000($a0)
	...
	la.l    $t1, _Na_work_bss_10-0x10+0x5DFC
	lw      $t8, 0x0000($t1)
	lui     $a2, %hi(_Na_work_bss_10-0x10+0x5DE8)
	...
	mflo    $t7
	sw      $t7, 0x0000($a0)
	lw      $a2, %lo(_Na_work_bss_10-0x10+0x5DE8)($a2)
	sw      $0, 0x0040($t8)
	lw      $t9, 0x0000($t1)
	...
	sw      $t8, 0x0014($v1)
	sll     $t6, $t5, 3
	lui     $t8, %hi(_Na_work_bss_10-0x10+0x5DF0)
	sll     $t7, $a2, 2
	addu    $t8, $t8, $t7
	sw      $0, 0x0004($v1)
	sw      $a1, 0x0008($v1)
	...
	sw      $0, 0x0028($v1)
	sw      $0, 0x002C($v1)
	lw      $t8, %lo(_Na_work_bss_10-0x10+0x5DF0)($t8)
	sw      $t8, 0x0030($v1)
	lw      $t9, 0x0040($sp)
	sw      $0, 0x0038($v1)
	sw      $0, 0x003C($v1)
...
39$:
	sll     $t5, $a2, 2
	lui     $a1, %hi(_Na_work_bss_10-0x10+0x1B24)
	addu    $a1, $a1, $t5
	lw      $a1, %lo(_Na_work_bss_10-0x10+0x1B24)($a1)
	sll     $t7, $v0, 2
	subu    $t7, $t7, $v0
	addu    $t8, $t7, $v1
	li      $at, 0x3F800000
...
Na_game_8031FDAC:
	...
	nop
	la.u    $s8, _Na_work_bss_10-0x10+0x1878
	la.l    $s8, _Na_work_bss_10-0x10+0x1878
	lw      $t7, 0x02AC($s8)
	la.u    $t6, _Na_work_bss_10-0x10+0x4E38
	la.l    $t6, _Na_work_bss_10-0x10+0x4E38
	beq     $t6, $t7, 468$
	move    $s4, $0
	li      $at, 0x41800000
	mtc1    $at, $f30
...
29$:
	...
	addu    $t8, $t8, $a0
	sll     $t8, $t8, 6
	lui     $at, %hi(_Na_work_bss_10-0x10+0x1879)
	addu    $at, $at, $t8
	andi    $t7, $a3, 0x0080
	sb      $t7, %lo(_Na_work_bss_10-0x10+0x1879)($at)
	lw      $a1, 0x0018($sp)
	move    $a2, $0
	...
	li      $t9, 0x0004
	mtc1    $v0, $f4
	lui     $at, %hi(_Na_work_bss_10-0x10+0x187A)
	sb      $t9, %lo(_Na_work_bss_10-0x10+0x187A)($at)
	bgez    $v0, 65$
	cvt.s.w $f6, $f4
	li      $at, 0x4F800000
	mtc1    $at, $f8
...
65$:
	li      $at, 0x42FE0000
	mtc1    $at, $f10
	lui     $at, %hi(_Na_work_bss_10-0x10+0x1890)
	div.s   $f16, $f6, $f10
	b       73$
	swc1    $f16, %lo(_Na_work_bss_10-0x10+0x1890)($at)
71$:
...
Na_game_80320734:
	...
	sll     $t1, $t7, 2
	addu    $t2, $t0, $t1
	lui     $v0, %hi(_Na_work_bss_10-0x10+0x18A4)
	addu    $v0, $v0, $t2
	lw      $v0, %lo(_Na_work_bss_10-0x10+0x18A4)($v0)
	la.u    $t3, _Na_work_bss_10-0x10+0x4E38
	sw      $a2, 0x0008($sp)
	andi    $t8, $a2, 0x00FF
	sw      $a3, 0x000C($sp)
	andi    $t9, $a3, 0xFFFF
	la.l    $t3, _Na_work_bss_10-0x10+0x4E38
	move    $a3, $t9
	move    $a2, $t8
	sw      $a0, 0x0000($sp)
	beq     $t3, $v0, 52$
...
Na_game_8032080C:
	...
	la.u    $t0, _Na_work_bss_10-0x10+0x4E38
	mtc1    $at, $f0
	move    $a0, $t6
	la.l    $t0, _Na_work_bss_10-0x10+0x4E38
...
11$:
	sll     $t1, $a0, 2
	addu    $t1, $t1, $a0
	la.u    $t2, _Na_work_bss_10-0x10+0x1878
	li      $at, 0x3F800000
	la.l    $t2, _Na_work_bss_10-0x10+0x1878
	sll     $t1, $t1, 6
	la.u    $a3, _Na_work_bss_10-0x10+0x4E38
	mtc1    $at, $f2
	la.l    $a3, _Na_work_bss_10-0x10+0x4E38
	addu    $v1, $t1, $t2
	move    $v0, $0
22$:
	sll     $t3, $v0, 2
...
17$:
	...
	addu    $t9, $t9, $a0
	sll     $t9, $t9, 6
	lui     $t0, %hi(_Na_work_bss_10-0x10+0x1878)
	addu    $t0, $t0, $t9
	lw      $t0, %lo(_Na_work_bss_10-0x10+0x1878)($t0)
	li      $at, 0x0001
	move    $a0, $a3
	srl     $t1, $t0, 31
	bnel    $t1, $at, 31$
...
Na_SeqUnmute:
	...
	addu    $t7, $t7, $t6
	sll     $t7, $t7, 6
	lui     $t8, %hi(_Na_work_bss_10-0x10+0x187A)
	addu    $t8, $t8, $t7
	lbu     $t8, %lo(_Na_work_bss_10-0x10+0x187A)($t8)
	li      $at, 0x0001
	beql    $t8, $at, 38$
	lw      $ra, 0x0014($sp)
	jal     Na_game_80320F68
...
Na_game_80320F68:
	...
	li      $at, 0x001A
	bne     $t0, $at, 13$
	la.u    $a3, _Na_work_bss_10-0x10+0x1878
11$:
	b       87$
	li      $v0, 0x00FF
13$:
	la.l    $a3, _Na_work_bss_10-0x10+0x1878
	lwc1    $f6, 0x0020($a3)
	mtc1    $0, $f4
	lhu     $t6, 0x0022($sp)
...
Na_Pause:
	move    $a1, $a0
	sw      $a0, 0x0000($sp)
	la.u    $a0, _Na_work_bss_10-0x10+0x1878
	sll     $t7, $a1, 5
	andi    $a1, $t7, 0x0020
	la.l    $a0, _Na_work_bss_10-0x10+0x1878
	move    $v0, $0
	li      $a2, 0x0140
8$:
	multu   $v0, $a2
...
Na_game_803217A8:
	...
	sw      $s2, 0x0020($sp)
	sw      $s0, 0x0018($sp)
	la.u    $s1, _Na_work_bss_10-0x10+0x1878
	sw      $ra, 0x0024($sp)
	la.l    $s1, _Na_work_bss_10-0x10+0x1878
	move    $s0, $0
	li      $s2, 0x0140
9$:
	multu   $s0, $s2
...
Na_game_80321864:
	...
	addu    $v0, $v0, $t1
	lw      $v0, %lo(_Na_work_bss_10-0x10+0x18A4)($v0)
	la.u    $t2, _Na_work_bss_10-0x10+0x4E38
	sw      $a2, 0x0008($sp)
	andi    $t8, $a2, 0x00FF
	la.l    $t2, _Na_work_bss_10-0x10+0x4E38
	move    $a2, $t8
	sw      $a0, 0x0000($sp)
	sw      $a1, 0x0004($sp)
	beq     $t2, $v0, 27$
...
28$:
	...
	addiu   $a0, $a0, 0x0001
	bnez    $a0, 41$
	la.u    $t9, _Na_work_bss_10-0x10+0x1878
	move    $a0, $0
	lbu     $a1, 0x001B($sp)
	jal     Na_game_80320544
	lhu     $a2, 0x003A($sp)
	...
	lw      $ra, 0x0014($sp)
41$:
	la.l    $t9, _Na_work_bss_10-0x10+0x1878
	lw      $t4, 0x0000($t9)
	srl     $t5, $t4, 31
	bnezl   $t5, 125$
	lw      $ra, 0x0014($sp)
...
Na_game_80321D9C:
	addiu   $sp, $sp, -0x0018
	la.u    $t6, _Na_work_bss_10-0x10+0x1878
	sw      $ra, 0x0014($sp)
	la.l    $t6, _Na_work_bss_10-0x10+0x1878
	lw      $t7, 0x0140($t6)
...
39$:
	...
	sb      $t0, 0x0000($v0)
	sra     $t2, $t1, 4
	sb      $t2, %lo(_Na_work_bss_10-0x10+0x5DDF)($at)
	lui     $at, %hi(Na_game_8033321C)
	lw      $s0, 0x0018($sp)
...
Na_Output:
	...
	sw      $a0, 0x0000($sp)
	jr      $ra
	sb      $a0, %lo(_Na_work_bss_10-0x10+0x5DDF)($at)
